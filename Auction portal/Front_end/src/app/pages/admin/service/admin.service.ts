...
export class AdminService {
  ...
  getTemplate(): Observable<any> {
    return this.http.get(environment.baseAPIUrl + Endpoints.CATEGORYBANNER + '/' + Endpoints.VIEWEMPLATE);
  }

  getTemplateById(id: any): Observable<any> {
    return this.http.get(environment.baseAPIUrl + Endpoints.CATEGORYBANNER + '/' + Endpoints.GETTEMPLATEBYID + '/' + id);
  }

  editTemplate(id: any, postData: any): Observable<any> {
    return this.http.put(environment.baseAPIUrl + Endpoints.CATEGORYBANNER + '/' + Endpoints.EDITBANNERBYID + '/' + id, postData);
  }
  ...
  addCategory(postData: any): Observable<any> {
    return this.http.post(environment.baseAPIUrl + Endpoints.INVENTORY + '/' + Endpoints.ADDCATEGORY, postData);
  }

  editCategory(id: any, postData: any): Observable<any> {
    return this.http.post(environment.baseAPIUrl + Endpoints.INVENTORY + '/' + Endpoints.UPDATECATGORYBYID + '/' + id, postData);
  }

  categoryById(id: any): Observable<any> {
    return this.http.get(environment.baseAPIUrl + Endpoints.INVENTORY + '/' + Endpoints.GETCATEGORYBYID + '/' + id);
  }

  deleteCategoryById(id: any): Observable<any> {
    return this.http.delete(environment.baseAPIUrl + Endpoints.INVENTORY + '/' + Endpoints.DELETECATEGORYBYID + '/' + id);
  }

  itemList(): Observable<any> {
    return this.http.get(environment.baseAPIUrl + Endpoints.INVENTORY + '/' + Endpoints.ALLINVELTORYITEMLIST);
  }

  soldItemList(): Observable<any> {
    return this.http.get(environment.baseAPIUrl + Endpoints.INVENTORY + '/' + Endpoints.SOLDOUTITEMS);
  }
}