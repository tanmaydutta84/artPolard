...
export class SidebarComponent implements OnInit {
  ...
  constructor(
    ...
    this.cuatomerServiceMenu = this.menuItems.getCustomerServiceMenuItem();
  ...
  redirectToPages(child: any) {
    this.route.navigate(['/pages' + '/customer-service/' + child.state || child.menuitem.state]);
    // if (localStorage.getItem('isAdminLoggedIn') == 'true') {
